...
import br.com.smal.persistence.AdministradorDao;

@Component
public class AdministradorDaoJpa extends GenericDaoJpa<Administrador>
		implements
			AdministradorDao {
	...
	public boolean existe(Administrador entidade) {
		Administrador administradorExistente = getAdministradorPorMatricula(entidade
				.getMatricula());
