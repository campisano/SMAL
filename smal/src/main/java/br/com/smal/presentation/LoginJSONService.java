...
public class LoginJSONService {
 ...
 public RespostaJSON<Object> logar(Tecnico usuario, @Context HttpServletRequest req){
 ...
 @Consumes("application/json; charset=UTF-8")
 @Produces("application/json; charset=UTF-8")
 public RespostaJSON<Object> logout(Tecnico usuario, @Context HttpServletRequest req){
